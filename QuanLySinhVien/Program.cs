                ...
                try
                {
                    ...
                    if (!dbContext.SinhViens.Any())
                    {
                        ...
                        dbContext.SinhViens.AddRange(
                            new SinhVien { Ten = "Nguyen Ly Na", Tuoi = 19, LopId = 1 },
                            new SinhVien { Ten = "Tran Hong Phong", Tuoi = 20, LopId = 2 },
                            new SinhVien { Ten = "Le Thong NHat", Tuoi = 27, LopId = 1 },
                            new SinhVien { Ten = "Le Van Duy", Tuoi = 19, LopId = 1 },
                            new SinhVien { Ten = "Dang Van Be", Tuoi = 23, LopId = 2 },
